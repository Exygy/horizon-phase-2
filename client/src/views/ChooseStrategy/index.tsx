...
class ChooseStrategyView extends React.Component<Props, State> {
  ...
  recordChoiceAndRedirect = async () => {
    ...
    if (!data.error) {
        ...
        this.props.history.push(`${stepIdPath}?lang=${queryString.parse(this.props.location.search).lang}&coins_spent=${coinsSpent}`)
    }
    ...
    return (
      <div id="choose-strategy-view" className="view">
        <Main stepId={this.props.match.params.stepId}>
            ...
            <CustomHeader stepId={this.props.match.params.stepId} lang={queryString.parse(this.props.location.search).lang}/>
                ...
                <div className="carousel-holder">
                        <Carousel showIndicators={false} showStatus={false} showArrows={false} showThumbs={false} selectedItem={this.state.selectedItem} onChange={this.updateCurrentSlide}>
        <ReactCardFlip
            isFlipped={this.state.flippedStates[0]}
            flipDirection="horizontal">
            <div key="front">
                <div className="content-box">
                        <Button size='large' className="nav prev-btn" disabled circular icon='arrow left' onClick={this.prev} />
                        <Button size='large' className="nav next-btn" circular icon='arrow right' onClick={this.next} />
                        ...
                        <Grid>
                            <Grid.Column width={8} className="col-left">
                                <Button className="btn secondary" onClick={() => this.handleClick(0)}>Click to flip</Button>
                            </Grid.Column>
            ...
            <div key="back">
                <div className="content-box">
                        ...
                        <Button className="btn secondary" onClick={() => this.handleClick(0)}>Flip over</Button>
                </div>
            </div>
        </ReactCardFlip>
        <ReactCardFlip
        ...
        cardZIndex={-100}
            ...
            <div key="front">
                <div className="content-box">
                        <Button size='large' className="nav prev-btn" circular icon='arrow left' onClick={this.prev} />
                        <Button size='large' className="nav next-btn" circular icon='arrow right' onClick={this.next} disabled={parseInt(this.props.match.params.stepId) === 203}/>
                        ...
                        <Grid>
                            <Grid.Column width={8} className="col-left">
                                <Button className="btn secondary" onClick={() => this.handleClick(1)}>Click to flip</Button>
                            </Grid.Column>
                            <Grid.Column width={8} className="col-right">
            ...
            <div key="back">
                <div className="content-box">
                        ...
                        <Button className="btn secondary" onClick={() => this.handleClick(1)}>Flip over</Button>
                </div>
            </div>
        </ReactCardFlip>
        {parseInt(this.props.match.params.stepId) !== 203 && 
        <ReactCardFlip
            isFlipped={this.state.flippedStates[2]}
            flipDirection="horizontal">
            <div key="front">
                <div className="content-box">
                        <Button size='large' className="nav prev-btn" circular icon='arrow left' onClick={this.prev} />
                        <Button size='large' className="nav next-btn" circular icon='arrow right' onClick={this.next} disabled />
                        ...
                        <Grid>
                            <Grid.Column width={8} className="col-left">
                                <Button className="btn secondary" onClick={() => this.handleClick(2)}>Click to flip</Button>
                            </Grid.Column>
                            <Grid.Column width={8} className="col-right">
            ...
            <div key="back">
                <div className="content-box">
                        ...
                        <Button className="btn secondary" onClick={() => this.handleClick(2)}>Flip over</Button>
                </div>
            </div>
        </ReactCardFlip>
        }
            ...
            <div className="custom-btn-holder">
                <Button onClick={this.recordChoiceAndRedirect} className="btn primary">Choose this strategy</Button>
            </div>
                </div>
            </Form>
        </Main>
