...
class OnboardingElectedView extends React.Component<Props, {}> {
  componentDidMount = () => {
  }
      ...
      <div className="view">
        ...
        <div>
            ...
            <div className="btn-holder">
                <Button className="btn primary" as={Link} to={`/onboarding/your-challenge/10004?lang=${queryString.parse(this.props.location.search).lang}`}>{step && step.publicField3}</Button>
            </div>
        </Form>
        </Main>
      </div>
