...
class Query(object):
    ...
    strategy_choice_summary = graphene.Field(StrategyChoiceSummaryType, id=graphene.ID(), lang=graphene.String(), session_id=graphene.UUID(), render_md_to_html=graphene.Boolean())
