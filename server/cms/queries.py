...
class Query(object):
    ...
    strategy_choice_summary = graphene.Field(StrategyChoiceSummaryType, id=graphene.ID(), lang=graphene.String(), session_id=graphene.UUID())
    ...
    def resolve_strategy_choice_summary(self, info, **args):
        ...
        info.context.args = dict(step_id=step_id, session_id=session_id)
